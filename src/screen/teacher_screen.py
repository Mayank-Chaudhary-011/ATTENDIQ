...
def teacher_dashboard():
    ...
    with tab3:
        ...
        if st.button('Attendace Records',type=type3, width='stretch',icon=':material/cards_stack:'):
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username" , placeholder="Mayank Chaudhary")
    ...
    with btn1:
        if st.button('Login',icon=':material/passkey:',shortcut='control+enter',width='stretch'):
            if login_teacher(teacher_username,teacher_pass):
                ...
                st.error("Invalid Username and Pssward combo")
    with btn2:
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username = st.text_input("Enter username" , placeholder="Mayank Chaudhary")
    teacher_name = st.text_input("Enter Name" , placeholder="Mayank Chaudhary")
    teacher_pass = st.text_input("Enter passward" , type='password',placeholder="Enter passward")
    teacher_pass_confirm = st.text_input("Confirm your passward" , type='password',placeholder="Enter passward")
